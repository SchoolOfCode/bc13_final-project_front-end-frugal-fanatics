...
//check that you can add to holiday Pot (pot 1)
...
//check that you can add to nursery Pot (pot 1)
...
//check that you can add to birthday Pot (pot 1)
describe("When you click add savings under pot 4 a modal appears", () => {
	it("should open a modal to add to the savings pot", () => {
		// Start from the savings page
		cy.visit("/savings");
		//find add savings button and click it
