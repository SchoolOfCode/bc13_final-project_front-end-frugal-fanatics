              ...
              <div className="center space-x-5 ">
                <button
                  className="mt-16 inline-flex items-center justify-center rounded-lg border-2 border-slate-800 bg-[#108F68]
										px-7 py-2.5 text-lg font-normal tracking-wide text-white transition-colors hover:bg-[#10B981]
                ...
                <button
                  className=" mt-16 inline-flex items-center justify-center rounded-lg border-2 border-white px-7
										py-2.5 text-lg font-normal tracking-wide text-white transition-colors hover:bg-white
