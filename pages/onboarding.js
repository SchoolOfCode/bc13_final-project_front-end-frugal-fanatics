          ...
          {formStep === 2 && !isFormComplete && (
            ...
            >
              <FormText
                ...
                description="Enter the amount you spend on each of these expenses. Please for any that don't apply to you leave blank."
              />
              <div className="py-5">
          ...
          {formStep === 3 && !isFormComplete && (
            ...
            >
              <FormText
                ...
                description="Please add your total savings and any potential savings goal amount."
              />
              <div className="py-5">
                <div className="flex flex-col gap-8">
                  <FormInput
